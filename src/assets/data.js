...
export const questions = [
    {
      text: "What type of stories are you most drawn to?",
      options: ["Mystery and thrillers", "Romance and drama", "Science fiction and fantasy"]
    },
    {
      text: "Which setting do you enjoy most in a book?",
      options: ["Historical worlds", "Modern urban life", "Futuristic or magical realms"]
    },
    {
      text: "How do you prefer to feel after finishing a book?",
      options: ["Inspired and motivated", "Emotionally touched", "Intrigued and thoughtful"]
    }
  ];
